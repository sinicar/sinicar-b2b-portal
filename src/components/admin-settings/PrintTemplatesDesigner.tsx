...
export const PrintTemplatesDesigner: FC<PrintTemplatesDesignerProps> = ({ t }) => {
    const [templates, setTemplates] = useState<DocumentTemplate[]>([
        { id: 'INVOICE', name: 'فاتورة', nameEn: 'Invoice', nameAr: 'فاتورة', type: 'invoice', isDefault: true, isActive: true,
          pageSize: 'A4', orientation: 'portrait', margins: { top: 20, right: 20, bottom: 20, left: 20 },
          header: { enabled: true, height: 80, showLogo: true, logoPosition: 'right', showCompanyInfo: true, showCompanyName: true, showDate: true, showPageNumber: false },
          footer: { enabled: true, height: 40, showPageNumbers: true, showPageNumber: true, customText: 'شكراً لتعاملكم معنا', showLogo: false, showCompanyName: false, showDate: false },
          columns: ['productName', 'sku', 'quantity', 'unitPrice', 'total'],
          fonts: { heading: 'Cairo', body: 'Cairo', size: { heading: 16, body: 12 } },
          primaryColor: '#1e3a5f', secondaryColor: '#f59e0b', fontFamily: 'Cairo', fontSize: 12,
          colors: { primary: '#1e3a5f', secondary: '#f59e0b', text: '#1f2937', border: '#e5e7eb' } },
        { id: 'QUOTE', name: 'عرض سعر', nameEn: 'Quotation', nameAr: 'عرض سعر', type: 'quote', isDefault: false, isActive: true,
          pageSize: 'A4', orientation: 'portrait', margins: { top: 25, right: 25, bottom: 25, left: 25 },
          header: { enabled: true, height: 100, showLogo: true, logoPosition: 'center', showCompanyInfo: true, showCompanyName: true, showDate: true, showPageNumber: false },
          footer: { enabled: true, height: 50, showPageNumbers: true, showPageNumber: true, customText: 'عرض السعر ساري لمدة 7 أيام', showLogo: false, showCompanyName: false, showDate: false },
          columns: ['productName', 'sku', 'quantity', 'unitPrice', 'discount', 'total'],
          fonts: { heading: 'Cairo', body: 'Cairo', size: { heading: 18, body: 11 } },
          primaryColor: '#059669', secondaryColor: '#fbbf24', fontFamily: 'Cairo', fontSize: 11,
          colors: { primary: '#059669', secondary: '#fbbf24', text: '#374151', border: '#d1d5db' } },
        { id: 'PACKING_LIST', name: 'قائمة التعبئة', nameEn: 'Packing List', nameAr: 'قائمة التعبئة', type: 'packing', isDefault: false, isActive: true,
          pageSize: 'A4', orientation: 'portrait', margins: { top: 15, right: 15, bottom: 15, left: 15 },
          header: { enabled: true, height: 60, showLogo: true, logoPosition: 'left', showCompanyInfo: false, showCompanyName: false, showDate: true, showPageNumber: false },
          footer: { enabled: false, height: 0, showPageNumbers: false, showPageNumber: false, customText: '', showLogo: false, showCompanyName: false, showDate: false },
          columns: ['productName', 'sku', 'quantity', 'location', 'notes'],
          fonts: { heading: 'Cairo', body: 'Cairo', size: { heading: 14, body: 10 } },
          primaryColor: '#7c3aed', secondaryColor: '#a78bfa', fontFamily: 'Cairo', fontSize: 10,
          colors: { primary: '#7c3aed', secondary: '#a78bfa', text: '#4b5563', border: '#e5e7eb' } },
        { id: 'DELIVERY_NOTE', name: 'إذن تسليم', nameEn: 'Delivery Note', nameAr: 'إذن تسليم', type: 'delivery', isDefault: false, isActive: true,
          pageSize: 'A4', orientation: 'portrait', margins: { top: 20, right: 20, bottom: 20, left: 20 },
          header: { enabled: true, height: 70, showLogo: true, logoPosition: 'right', showCompanyInfo: true, showCompanyName: true, showDate: true, showPageNumber: false },
          footer: { enabled: true, height: 60, showPageNumbers: false, showPageNumber: false, customText: 'توقيع المستلم: ____________', showLogo: false, showCompanyName: false, showDate: false },
          columns: ['productName', 'quantity', 'notes'],
          fonts: { heading: 'Cairo', body: 'Cairo', size: { heading: 15, body: 11 } },
          primaryColor: '#0891b2', secondaryColor: '#06b6d4', fontFamily: 'Cairo', fontSize: 11,
