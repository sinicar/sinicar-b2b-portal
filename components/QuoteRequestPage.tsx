    ...
    <div className="w-full animate-fade-in py-8 space-y-10">
        ...
        {!isSuccess ? (
            <div className="bg-white rounded-3xl shadow-lg border border-slate-100 overflow-hidden relative">
                <div className="bg-gradient-to-r from-slate-800 to-slate-900 p-10 text-white">
                    <div className="flex justify-between items-start">
                        <div>
                            <h2 className="text-3xl font-black mb-3">رفع طلب تسعير (Bulk Request)</h2>
                            <p className="text-slate-200 text-lg font-medium">نظام ذكي لمعالجة ملفات Excel وتسعير مئات الأصناف.</p>
                        </div>
                        <button 
                    ...
                    <div className="mb-10">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            >
                                ...
                                <p className="text-sm text-slate-500 font-medium">الحصول على أفضل عرض سعر متاح من النوعين.</p>
                            </button>
                        </div>
                    </div>
            ...
            <div className="bg-white rounded-3xl shadow-lg border border-green-100 p-16 text-center animate-fade-in relative overflow-hidden">
                ...
                <h2 className="text-3xl font-black text-slate-800 mb-4">تم استلام طلب التسعير</h2>
             ...
             <div className="fixed top-0 left-0 -z-50 opacity-0 pointer-events-none">
                 <div ref={printRef} className="bg-white p-10 w-[210mm] min-h-[297mm] text-slate-900 font-sans" dir="rtl">
                     ...
                     <div className="flex justify-between items-start border-b-2 border-slate-800 pb-6 mb-8">
                         <div>
                             <h1 className="text-3xl font-black text-slate-900 mb-2">عرض سعر / Quotation</h1>
